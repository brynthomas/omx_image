...
// I was trying to make everything nicely deterministic without relying on timeouts and
// just following events perfectly. Well sometimes OMX just goes quiet when it has an error
// and the only way I'm going to get that is a timeout. Pity. Have this ugly error and timeout
// global that I will relook at once I have my error and timeout conditions more nailed down.
int error_timeout;
